  ...
  return (
    <Html lang="en">
      ...
      <meta property="og:type" content="website" />
          ...
          <meta property="og:image" content="https://walph.io/images/android-chrome-512x512.png" />
          ...
          <meta property="twitter:image" content="https://walph.io/images/android-chrome-512x512.png" />
      </Head>
      <body>
        <Main />
        <NextScript />
